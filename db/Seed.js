...
// Step 2: Users Methods;
    ...
    async function createInitialTreatmentPlan() {
        ...
        try {
            ...
            await createTreatmentPlan({
                plan: 'Congestive Heart Failure Treatment',
                patient_id: 349,
                provider_id: 2655
                });
            await createTreatmentPlan({
            ...
            await createTreatmentPlan({
                plan: 'Cardiovascular Disease Treatment',
                patient_id: 376,
                provider_id: 5655
                });
            await createTreatmentPlan({
            ...
            await createTreatmentPlan({
                plan: 'Infectious Mononucleosis Treatment',
                patient_id: 379,
                provider_id: 5643
                });
            await createTreatmentPlan({
